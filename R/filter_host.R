...
#' Align reads against one or more filter libraries and subsequently remove
#' mapped reads
#'
...
#' be used upstream for further analysis.
#'
#' @inheritParams filter_host_bowtie
...
#'   is \code{FALSE}.
#' @param output The desired name of the output .bam or .rds file. Extension is

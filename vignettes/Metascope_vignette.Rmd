...
MetaScope is based on the previous package Pathoscope 2.0 (Hong 2014). In the same manner as the module, Metascope consists of multiple workflows to carry out metagenomic profiling. 

**CHANGE THIS TO REFLECT METASCOPE Workflows**
...
## Working Directory
**Include a quick note about the working directory**
...
**Add code to create filter library**

## Demultiplex
**Add something here to explain Demultiplex step if needed**
- Will be used for 16s experiments or illumina experiments
- If somebody did illumina sequencing, had two files with read barcodes and indexes, then you could use demultiplex on those two files
- Part of pre-processing, another module
...
viral_map <- align_r(readPath2, "viral", "virus_example")
```

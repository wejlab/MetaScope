...
![Figure 1. The MetaScope workflow and its associated modules with function descriptions. The MetaRef, MetaAlign, MetaFilter, and MetaID modules form the backbone of package operation, whereas the MetaDemultiplex, MetaBLAST, and MetaCombine modules are complementary to the core package functionality.](~/pathoscope/work/aubrey/MetaScope/vignettes/docs/MetaScope Workflow.png)
...
all_species <- c("Staphylococcus aureus subsp. aureus Mu50",
                 ...
                 "Staphylococcus aureus RF122", "Staphylococcus aureus subsp. aureus ST398")
